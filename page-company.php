    ...
    <div class="page-wrapper d-flex flex-column min-vh-60 mb-5">
		...
		<div class="container mt-5">
            <div class="about-wrap">
                    <h2 class="mt-5 mb-3">О компании</h2>
                <div class="d-flex about-info">
                    <div class="about-info-text">
                        <p>
                            <b>ООО "Технология-НК"</b> - завод, специализирующийся на разработке,
                    ...
                    <div class="about-info-img">
                        <div class="owl-start owl-carousel owl-theme">
                            <div class="item"><img src="/img/content/VRU/1.jpg" alt=""></div>
                            <div class="item"><img src="/img/content/VRU/2.jpg" alt=""></div>
                            <div class="item"><img src="/img/content/VRU/3.jpg" alt=""></div>
                            <div class="item"><img src="/img/content/VRU/4.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
